...
class ViewController: UIViewController {
    ...
    func state_change(sender: DigitalInput, state:Bool){
        do{
            ...
            if buttonpressed == "askQuestionGreen"{
    ...
    @IBAction func pickedAnswer(_ sender: UIButton) {
        ...
        do{
            ...
            try button.setDeviceSerialNumber(528040)
            try button.setHubPort(2)
            try button.setIsHubPortDevice(true)
            
            try button1.setDeviceSerialNumber(528040)
            ...
            try led1.setDeviceSerialNumber(528040)
            try led1.setHubPort(1)
            try led1.setIsHubPortDevice(true)
            
            try led2.setDeviceSerialNumber(528040)
